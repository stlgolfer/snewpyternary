...
python binder.py -nux ./sigmas/${model}_s0_AdiabaticMSW_IMO_BstChnl_nu_mu_sigma_average.csv -nue ./sigmas/${model}_s0_AdiabaticMSW_IMO_BstChnl_nu_e_sigma_average.csv -anue ./sigmas/${model}_s0_AdiabaticMSW_IMO_BstChnl_nu_e_bar_sigma_average.csv --title=${model}_s0_AdiabaticMSW_IMO &&
python binder.py -nux ./sigmas/${model}_s0_AdiabaticMSW_NMO_BstChnl_nu_mu_sigma_average.csv -nue ./sigmas/${model}_s0_AdiabaticMSW_NMO_BstChnl_nu_e_sigma_average.csv -anue ./sigmas/${model}_s0_AdiabaticMSW_NMO_BstChnl_nu_e_bar_sigma_average.csv --title=${model}_s0_AdiabaticMSW_NMO
done
