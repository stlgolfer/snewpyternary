...
def set_diagram(tax):
    ...
    tax.bottom_axis_label('Scint. Neutral Current', fontsize=TERNARY_AXES_LABEL_FONT_SIZE-2)
    tax.right_axis_label('Water IBD', fontsize=TERNARY_AXES_LABEL_FONT_SIZE-2)
    tax.left_axis_label('Argon Charged Current', fontsize=TERNARY_AXES_LABEL_FONT_SIZE-2)
    tax.ticks(axis='lbr', linewidth=0.8, multiple=scale / 10)
