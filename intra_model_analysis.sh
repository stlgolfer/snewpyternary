...
python sigma_average.py $model -p NoTransformation -flavor nux --submodel=${i} && python sigma_average.py $model -p NoTransformation -flavor nue --submodel=${i} && python sigma_average.py $model -p NoTransformation -flavor anue --submodel=${i} &&
