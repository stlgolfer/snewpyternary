...
nakazato_vanilla = pd.read_csv('./binders/Nakazato_2013_s0_NoTransformation_nocsum_unfolded.csv')
nakazato_imo = pd.read_csv('./binders/Nakazato_2013_s0_AdiabaticMSW_IMO_nocsum_unfolded.csv')
nakazato_nmo = pd.read_csv('./binders/Nakazato_2013_s0_AdiabaticMSW_NMO_nocsum_unfolded.csv')
...
fig.tight_layout()
fig.savefig('./unfolded_flux_comparison.png')
