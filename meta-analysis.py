...
transform_list = ['NoTransformation','AdiabaticMSW_NMO'] #list(flavor_transformation_dict.keys())
...
for d in detector_list:
    ...
    for transform in transform_list:
        ...
        plot_data = t.create_detector_event_scatter(modelFilePathBase, modelFilePath, d, model,transformation=transform)
