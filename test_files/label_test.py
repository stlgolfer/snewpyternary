...
t.create_default_detector_plot([(98,1,1)], ['top','right','left'], 'Plot test')
t.create_default_detector_plot([(1,1,98)], ['top','right','left'], 'Plot test 2')

p_data, r_data = t.create_flux_scatter(modelFilePath, model_type, model, 0.01*u.s,use_cache=True)
